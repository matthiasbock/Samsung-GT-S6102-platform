...
ifeq ($(TARGET_PRODUCT), GT-S6102)
LOCAL_CFLAGS += -DBRCM21553_TORINO_BT
endif
...
ifeq ($(TARGET_PRODUCT), GT-S6102)
LOCAL_CFLAGS += -DBRCM21553_S6102_BT
endif

ifeq ($(TARGET_PRODUCT), GT-B5512)
LOCAL_CFLAGS += -DBRCM21553_LUISADS_BT
endif
